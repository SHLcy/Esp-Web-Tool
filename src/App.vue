<template>
  <div class="app">
    <div class="header">
      <h1 @click="handlePushToFrontPage"><img src="./assets/title.svg" alt=""> Esp Web Tool</h1>
    ...
    <footer>
      <img style="width: 25px;position: relative;top: 7px;" src="./assets/rebuild.svg" alt=""> Created by<a-button @click="handlePushToEsp" style="padding: 0 4px" type="link" ghost>@LNdidjdie</a-button>@ 2023
    </footer>
  </div>
</template>
...
const handlePushToEsp = () => {
  window.open('https://twitter.com/LNdidjdie', '_blank')
}
